...
public class PaymentResultSqlProvider {
     ...
     * @mbg.generated
     */
    public String countByExample(PaymentResultExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("payment_result");
     ...
     * @mbg.generated
     */
    public String deleteByExample(PaymentResultExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("payment_result");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated
     */
    public String insertSelective(PaymentResult record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("payment_result");
        ...
        if (record.getVoucherNo() != null) {
            sql.VALUES("voucher_no", "#{voucherNo,jdbcType=VARCHAR}");
        }
        ...
        if (record.getRealAmt() != null) {
            sql.VALUES("real_amt", "#{realAmt,jdbcType=VARCHAR}");
        }

        if (record.getDiscAmt() != null) {
            sql.VALUES("disc_amt", "#{discAmt,jdbcType=VARCHAR}");
        }
        ...
        if (record.getCouponType() != null) {
            sql.VALUES("coupon_type", "#{couponType,jdbcType=VARCHAR}");
        }

        if (record.getPayeeId() != null) {
            sql.VALUES("payee_id", "#{payeeId,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated
     */
    public String selectByExample(PaymentResultExample example) {
        SQL sql = new SQL();
        ...
        sql.SELECT("status");
        sql.SELECT("order_desc");
        sql.SELECT("voucher_no");
        sql.SELECT("amt");
        sql.SELECT("real_amt");
        sql.SELECT("disc_amt");
        sql.SELECT("coupon_id");
        sql.SELECT("coupon_desc");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        PaymentResult record = (PaymentResult) parameter.get("record");
        PaymentResultExample example = (PaymentResultExample) parameter.get("example");

        SQL sql = new SQL();
        sql.UPDATE("payment_result");
        ...
        if (record.getOrderDesc() != null) {
            sql.SET("order_desc = #{record.orderDesc,jdbcType=VARCHAR}");
        }

        if (record.getVoucherNo() != null) {
            sql.SET("voucher_no = #{record.voucherNo,jdbcType=VARCHAR}");
        }
        ...
        if (record.getRealAmt() != null) {
            sql.SET("real_amt = #{record.realAmt,jdbcType=VARCHAR}");
        }

        if (record.getDiscAmt() != null) {
            sql.SET("disc_amt = #{record.discAmt,jdbcType=VARCHAR}");
        }
        ...
        if (record.getCouponDesc() != null) {
            sql.SET("coupon_desc = #{record.couponDesc,jdbcType=VARCHAR}");
        }

        if (record.getCouponType() != null) {
            sql.SET("coupon_type = #{record.couponType,jdbcType=VARCHAR}");
        }

        if (record.getPayeeId() != null) {
            sql.SET("payee_id = #{record.payeeId,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(PaymentResult record) {
        SQL sql = new SQL();
        sql.UPDATE("payment_result");
        ...
        if (record.getVoucherNo() != null) {
            sql.SET("voucher_no = #{voucherNo,jdbcType=VARCHAR}");
        }
        ...
        if (record.getRealAmt() != null) {
            sql.SET("real_amt = #{realAmt,jdbcType=VARCHAR}");
        }

        if (record.getDiscAmt() != null) {
            sql.SET("disc_amt = #{discAmt,jdbcType=VARCHAR}");
        }
        ...
        if (record.getCouponType() != null) {
            sql.SET("coupon_type = #{couponType,jdbcType=VARCHAR}");
        }

        if (record.getPayeeId() != null) {
            sql.SET("payee_id = #{payeeId,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, PaymentResultExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
        ...
        List<PaymentResultExample.Criteria> oredCriteria = example.getOredCriteria();
        boolean firstCriteria = true;
        for (int i = 0; i < oredCriteria.size(); i++) {
            PaymentResultExample.Criteria criteria = oredCriteria.get(i);
            if (criteria.isValid()) {
                if (firstCriteria) {
                    firstCriteria = false;
                } else {
                ...
                sb.append('(');
                List<PaymentResultExample.Criterion> criterions = criteria.getAllCriteria();
                boolean firstCriterion = true;
                for (int j = 0; j < criterions.size(); j++) {
                    PaymentResultExample.Criterion criterion = criterions.get(j);
                    if (firstCriterion) {
